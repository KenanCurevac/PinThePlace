...
export default function GamePage() {
  ...
  return (
    <div className="game-grid min-h-[100dvh] overflow-x-hidden grid grid-rows-[1fr_1fr_8fr] md:grid-rows-[1fr_1fr_4fr_4fr] grid-cols-[1fr_1fr_1fr_1fr] md:grid-cols-[1fr_4fr_0.5fr] lg:grid-cols-[1fr_4fr_1fr] gap-3 lg:gap-4 p-4 md:p-6 lg:p-8 cursor-default">
      <div
